...
e,f),p[e]=!0):(!/^([a-zA-Z:]*\/\/)/.test(e)&&!s||e.replace(RegExp.$1,"").split("/")[0]===a.location.host)&&("//"===e.substring(0,2)&&(e=a.location.protocol+e),d.push({href:e,media:f})))}x()};y(),c.update=y,c.getEmValue=u,a.addEventListener?a.addEventListener("resize",b,!1):a.attachEvent&&a.attachEvent("onresize",b)}}(this);
INTELNAV.jQuery_1_11_1(function(){INTELNAV.jQuery_1_11_1(".search-results-header").on("click","span.text",function(){INTELNAV.jQuery_1_11_1("#ie8togCom").trigger("click");return false});INTELNAV.jQuery_1_11_1("#ie8togCom").click(function(){return false})});
